            ...
            action.setCallback(this, function(response) {
                ...
                if (state === "SUCCESS") {
                    ...
                    if(returnValue != null && returnValue ){
                        component.set('v.message','Please click below Save button, to sync all fields to Hansa Item.<br/><b>Note  - This will override all values in Hansa.</b>');
                        component.set("v.showSpinner",false);
                        component.set("v.showSave",true);
                    }else{
                        component.set('v.message','Please click below Save button, to create this Product as Item in Hansa.');
                        component.set("v.showSpinner",false);
                        component.set("v.showSave",true);
                    }
                }
